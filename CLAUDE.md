...
- **Committer**: Matthew G. Johnson <matthewgjohnson@gmail.com>
- **GitHub**: matthewgjohnson
...
ssh 192.168.128.66 "cd ~/turing-smart-screen-cli && git pull origin main && uv tool install --reinstall ."
```
